...
const equipesSchema = new mongoose.Schema({
    ...
    dateCreation: { type: String, required: false },
    stadeEquipe:{type:String, required:false},
    ligue:{
        type: String,
        required:true,
        ref:"Ligues"
...
// (Étape 4) Export du modèle Equipes
